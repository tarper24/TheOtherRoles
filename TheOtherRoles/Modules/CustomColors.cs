...
namespace TheOtherRoles.Modules
{
    public class CustomColors
    {
        ...
        private static readonly List<int> ORDER = new List<int>() { 7, 37, 14, 5, 33, 41, 25,
                                                                    ...
                                                                    2, 11, 26, 29, 20, 19, 18,
                                                                    12, 9, 24, 16, 15, 6, 39,
                                                                    42, 43, 44, 45, 46, 47, 48,  // Sona Colors
                                                                    49, 50, 51, 52, 53, 54 // Sona Colors
                                                                    };
        public static void Load()
        {
            ...
            {
                longname = "Sabor", // 42
                color = new Color32(91, 57, 38, byte.MaxValue),
                shadow = new Color32(73, 42, 31, byte.MaxValue),
                isLighterColor = false
            });
            // Bryoo
            // CF8D6B
            ...
            {
                longname = "Bryoo", // 43
                color = new Color32(207, 141, 107, byte.MaxValue),
                shadow = new Color32(179, 115, 92, byte.MaxValue),
                isLighterColor = true
            });
            // Markus
            // 654D33
            ...
            {
                longname = "Markus", // 44
                color = new Color32(101, 77, 51, byte.MaxValue),
                shadow = new Color32(82, 57, 41, byte.MaxValue),
                isLighterColor = false
            });
            // Mishka
            // 95E93B
            ...
            {
                longname = "Mishka", // 45
                color = new Color32(149, 233, 59, byte.MaxValue),
                shadow = new Color32(111, 170, 36, byte.MaxValue),
                isLighterColor = true
            });
            // Nymos
            // 463B30
            ...
            {
                longname = "Nymos", // 46
                color = new Color32(70, 59, 48, byte.MaxValue),
                shadow = new Color32(57, 44, 39, byte.MaxValue),
                isLighterColor = false
            });
            // Orion
            // 454545
            ...
            {
                longname = "Orion", // 47
                color = new Color32(69, 69, 69, byte.MaxValue),
                shadow = new Color32(56, 51, 56, byte.MaxValue),
                isLighterColor = false
            });
            // Potao
            // 404040
            ...
            colors.Add(new CustomColor
            {
                ...
                shadow = new Color32(52, 47, 51, byte.MaxValue),
                isLighterColor = false
            });
            // Yves
            // 777777
            ...
            {
                longname = "Yves", // 49
                color = new Color32(119, 119, 119, byte.MaxValue),
                shadow = new Color32(96, 88, 96, byte.MaxValue),
                isLighterColor = true
            });
            // Zerda
            // 4FF2F9
            ...
            {
                longname = "Zerda", // 50
                color = new Color32(79, 242, 249, byte.MaxValue),
                shadow = new Color32(72, 211, 225, byte.MaxValue),
                isLighterColor = true
            });
            // Pockets:
            // F7FAFC
            ...
            {
                longname = "Pockets", // 51
                color = new Color32(247, 250, 252, byte.MaxValue),
                shadow = new Color32(227, 222, 231, byte.MaxValue),
                isLighterColor = true
            });
            // Lavender/Ghost:
            // DEAAFF
            ...
            {
                longname = "Ghost", // 52
                color = new Color32(222, 170, 255, byte.MaxValue),
                shadow = new Color32(204, 151, 234, byte.MaxValue),
                isLighterColor = true
            });
            // Snarg:
            // 2E2D29
            ...
            {
                longname = "Snarg", // 53
                color = new Color32(46, 45, 41, byte.MaxValue),
                shadow = new Color32(37, 33, 33, byte.MaxValue),
                isLighterColor = false
            });
            // Neon:
            // 1E1E1E
            ...
            colors.Add(new CustomColor
            {
                ...
                shadow = new Color32(25, 23, 25, byte.MaxValue),
                isLighterColor = false
            });
